<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="enrollPlanList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="计划年度" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible"
                       prop="planYear"
      />
      <el-table-column label="专业代码" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible"
                       prop="spId"
      />
      <el-table-column label="专业名称" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible"
                       prop="spName"
      />
      <el-table-column label="系部ID" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible"
                       prop="stuDeptId"
      />
      <el-table-column label="系部名称" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible"
                       prop="stuDeptName"
      />
      <el-table-column label="学制" :show-overflow-tooltip="true" align="center" v-if="columns[6].visible"
                       prop="spLength"
      />
      <el-table-column label="科类ID" :show-overflow-tooltip="true" align="center" v-if="columns[7].visible"
                       prop="subjectSortId"
      />
      <el-table-column label="科类名称" :show-overflow-tooltip="true" align="center" v-if="columns[8].visible"
                       prop="subjectSortName"
      />
      <el-table-column label="省份编码" :show-overflow-tooltip="true" align="center" v-if="columns[9].visible"
                       prop="provinceCode"
      />
      <el-table-column label="省份名称" :show-overflow-tooltip="true" align="center" v-if="columns[10].visible"
                       prop="provinceName"
      />
      <el-table-column label="省份简称" :show-overflow-tooltip="true" align="center" v-if="columns[11].visible"
                       prop="provinceNameShort"
      />
      <el-table-column label="招生人数" :show-overflow-tooltip="true" align="center" v-if="columns[12].visible"
                       prop="planNum"
      />
      <el-table-column label="学费" :show-overflow-tooltip="true" align="center" v-if="columns[13].visible"
                       prop="tuitionFee"
      />
      <el-table-column label="创建者" :show-overflow-tooltip="true" align="center" v-if="columns[14].visible"
                       prop="createBy"
      />
      ...
      <el-table-column label="更新者" :show-overflow-tooltip="true" align="center" v-if="columns[16].visible"
                       prop="updateBy"
      />
