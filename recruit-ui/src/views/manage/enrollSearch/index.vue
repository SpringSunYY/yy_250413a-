  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="enrollSearchList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="考生ID" align="center" v-if="columns[0].visible" prop="stuEnrollId" />
        <el-table-column label="学号" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible" prop="stuNo" />
        <el-table-column label="班级" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="classId" />
        <el-table-column label="宿舍号" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="dormId" />
        <el-table-column label="辅导员" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible" prop="classTeacher" />
        <el-table-column label="辅导员联系方式" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible" prop="classTeacherContact" />
        <el-table-column label="QQ群" :show-overflow-tooltip="true" align="center" v-if="columns[6].visible" prop="classQq" />
...
<script>
import { listEnrollSearch, getEnrollSearch, delEnrollSearch, addEnrollSearch, updateEnrollSearch } from "@/api/manage/enrollSearch";
