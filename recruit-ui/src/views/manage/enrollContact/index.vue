  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="enrollContactList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="考生ID" align="center" v-if="columns[0].visible" prop="stuEnrollId" />
        <el-table-column label="联络人ID" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible" prop="taskUserId" />
        <el-table-column label="联络人姓名" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="taskUserName" />
        ...
        <el-table-column label="联络记录ID" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible" prop="contactId" />
        ...
        <el-table-column label="接听人" :show-overflow-tooltip="true" align="center" v-if="columns[8].visible" prop="answerPeopleName" />
        <el-table-column label="与考生关系" :show-overflow-tooltip="true" align="center" v-if="columns[9].visible" prop="answerPeopleRelation" />
        <el-table-column label="关系说明" :show-overflow-tooltip="true" align="center" v-if="columns[10].visible" prop="answerPeopleRemark" />
        <el-table-column label="回复内容" :show-overflow-tooltip="true" align="center" v-if="columns[11].visible" prop="replyContent" />
        <el-table-column label="回复说明" :show-overflow-tooltip="true" align="center" v-if="columns[12].visible" prop="replyContentRemark" />
        <el-table-column label="附件名称" :show-overflow-tooltip="true" align="center" v-if="columns[13].visible" prop="fileName" />
        <el-table-column label="附件后缀名" :show-overflow-tooltip="true" align="center" v-if="columns[14].visible" prop="fileSuffix" />
        ...
        <el-table-column label="创建者" :show-overflow-tooltip="true" align="center" v-if="columns[16].visible" prop="createBy" />
        <el-table-column label="创建时间" align="center" v-if="columns[17].visible" prop="createTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.createTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
        <el-table-column label="更新者" :show-overflow-tooltip="true" align="center" v-if="columns[18].visible" prop="updateBy" />
...
<script>
import { listEnrollContact, getEnrollContact, delEnrollContact, addEnrollContact, updateEnrollContact } from "@/api/manage/enrollContact";
    ...
    return {
      ...
      columns: [
        { key: 0, label: '考生ID', visible: true },
          ...
          { key: 9, label: '与考生关系', visible: true },
          { key: 10, label: '关系说明', visible: true },
          { key: 11, label: '回复内容', visible: true },
          { key: 12, label: '回复说明', visible: true },
          { key: 13, label: '附件名称', visible: true },
          { key: 14, label: '附件后缀名', visible: true },
