  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="enrollNoteList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="考生ID" align="center" v-if="columns[0].visible" prop="stuEnrollId" />
        <el-table-column label="通知书编号" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible" prop="noteCode" />
        <el-table-column label="通知书编号-前缀" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="noteCodePrefix" />
        <el-table-column label="通知书编号-后缀" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="noteCodeSuffix" />
        <el-table-column label="招生年度" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible" prop="planYear" />
        <el-table-column label="省份名称" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible" prop="provinceName" />
        <el-table-column label="录取院校" :show-overflow-tooltip="true" align="center" v-if="columns[6].visible" prop="stuDeptName" />
        <el-table-column label="录取专业" :show-overflow-tooltip="true" align="center" v-if="columns[7].visible" prop="stuMajor" />
        <el-table-column label="学生姓名" :show-overflow-tooltip="true" align="center" v-if="columns[8].visible" prop="stuName" />
        ...
        <el-table-column label="通知书防伪码" :show-overflow-tooltip="true" align="center" v-if="columns[10].visible" prop="noteSecurityCode" />
        <el-table-column label="通知书快递号" :show-overflow-tooltip="true" align="center" v-if="columns[11].visible" prop="noteExpCode" />
        ...
        <el-table-column label="通知书打印信息" :show-overflow-tooltip="true" align="center" v-if="columns[13].visible" prop="notePrintInfo" />
        <el-table-column label="通知书打印时间" align="center" v-if="columns[14].visible" prop="notePrintTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.notePrintTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
        <el-table-column label="创建者" :show-overflow-tooltip="true" align="center" v-if="columns[15].visible" prop="createBy" />
        <el-table-column label="创建时间" align="center" v-if="columns[16].visible" prop="createTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.createTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
        <el-table-column label="更新者" :show-overflow-tooltip="true" align="center" v-if="columns[17].visible" prop="updateBy" />
        <el-table-column label="更新时间" align="center" v-if="columns[18].visible" prop="updateTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.updateTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
        <el-table-column label="备注" :show-overflow-tooltip="true" align="center" v-if="columns[19].visible" prop="remark" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="通知书编号-前缀" prop="noteCodePrefix">
          <el-input v-model="form.noteCodePrefix" placeholder="请输入通知书编号-前缀" />
        </el-form-item>
        <el-form-item label="通知书编号-后缀" prop="noteCodeSuffix">
          <el-input v-model="form.noteCodeSuffix" placeholder="请输入通知书编号-后缀" />
        </el-form-item>
        <el-form-item label="招生年度" prop="planYear">
          <el-input v-model="form.planYear" placeholder="请输入招生年度" />
        </el-form-item>
        <el-form-item label="省份名称" prop="provinceName">
        ...
        <el-form-item label="通知书打印时间" prop="notePrintTime">
    ...
    return {
      ...
      columns: [
        { key: 0, label: '考生ID', visible: true },
          ...
          { key: 2, label: '通知书编号-前缀', visible: true },
          { key: 3, label: '通知书编号-后缀', visible: true },
          ...
          { key: 10, label: '通知书防伪码', visible: true },
          { key: 11, label: '通知书快递号', visible: true },
          { key: 12, label: '通知书打印', visible: true },
          { key: 13, label: '通知书打印信息', visible: true },
