 ...
 */
@Data
public class EnrollBasicInsert implements Serializable
{
     ...
     * 对象转封装类
     *
     * @param enrollBasicInsert 插入对象
     * @return EnrollBasicInsert
     */
    public static EnrollBasic insertToObj(EnrollBasicInsert enrollBasicInsert) {
        if (enrollBasicInsert == null) {
            return null;
        }
        EnrollBasic enrollBasic = new EnrollBasic();
        BeanUtils.copyProperties(enrollBasicInsert, enrollBasic);
        return enrollBasic;
    }
}
