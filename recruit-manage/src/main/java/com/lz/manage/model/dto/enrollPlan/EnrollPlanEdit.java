 ...
 */
@Data
public class EnrollPlanEdit implements Serializable
{
     ...
     * 对象转封装类
     *
     * @param enrollPlanEdit 编辑对象
     * @return EnrollPlan
     */
    public static EnrollPlan editToObj(EnrollPlanEdit enrollPlanEdit) {
        if (enrollPlanEdit == null) {
            return null;
        }
        EnrollPlan enrollPlan = new EnrollPlan();
        BeanUtils.copyProperties(enrollPlanEdit, enrollPlan);
        return enrollPlan;
    }
}
