 ...
 */
@Data
public class EnrollContactRecordEdit implements Serializable {
     ...
     * 对象转封装类
     *
     * @param enrollContactRecordEdit 编辑对象
     * @return EnrollContactRecord
     */
    public static EnrollContactRecord editToObj(EnrollContactRecordEdit enrollContactRecordEdit) {
        if (enrollContactRecordEdit == null) {
            return null;
        }
        EnrollContactRecord enrollContactRecord = new EnrollContactRecord();
        BeanUtils.copyProperties(enrollContactRecordEdit, enrollContactRecord);
        return enrollContactRecord;
    }
}
