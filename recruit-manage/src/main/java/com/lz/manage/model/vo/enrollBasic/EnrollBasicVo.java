package com.lz.manage.model.vo.enrollBasic;
 ...
 */
@Data
public class EnrollBasicVo implements Serializable
{
     ...
     * 对象转封装类
     *
     * @param enrollBasic EnrollBasic实体对象
     * @return EnrollBasicVo
     */
    public static EnrollBasicVo objToVo(EnrollBasic enrollBasic) {
        if (enrollBasic == null) {
            return null;
        }
        EnrollBasicVo enrollBasicVo = new EnrollBasicVo();
        BeanUtils.copyProperties(enrollBasic, enrollBasicVo);
        return enrollBasicVo;
    }
}
