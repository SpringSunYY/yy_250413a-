 ...
 */
@Data
public class EnrollNoteInsert implements Serializable
{
     ...
     * 对象转封装类
     *
     * @param enrollNoteInsert 插入对象
     * @return EnrollNoteInsert
     */
    public static EnrollNote insertToObj(EnrollNoteInsert enrollNoteInsert) {
        if (enrollNoteInsert == null) {
            return null;
        }
        EnrollNote enrollNote = new EnrollNote();
        BeanUtils.copyProperties(enrollNoteInsert, enrollNote);
        return enrollNote;
    }
}
