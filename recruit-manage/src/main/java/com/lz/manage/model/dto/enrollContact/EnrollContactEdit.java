 ...
 */
@Data
public class EnrollContactEdit implements Serializable
{
     ...
     * 对象转封装类
     *
     * @param enrollContactEdit 编辑对象
     * @return EnrollContact
     */
    public static EnrollContact editToObj(EnrollContactEdit enrollContactEdit) {
        if (enrollContactEdit == null) {
            return null;
        }
        EnrollContact enrollContact = new EnrollContact();
        BeanUtils.copyProperties(enrollContactEdit, enrollContact);
        return enrollContact;
    }
}
